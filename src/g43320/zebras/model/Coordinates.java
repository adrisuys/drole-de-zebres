...
/**
 * A Coordinate is a position on a board game stated by a number from 0 to 4 for
 * the line and 0 to 5 for the column.
 *
 * @author s_u_y_s_a
 */
public class Coordinates {
    ...
    /**
     * Returns true if a Coordinate is equal to the argument and false
     * otherwise.
     *
     * @param obj any object to be compared to the list.
     * @return true if a Coordinate is equal to the arguments and false
     * otherwise
     */
    @Override
